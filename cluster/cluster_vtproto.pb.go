...
func (m *MemberJoin) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *MemberJoin) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*MemberJoin)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (c *remoteClient) Receive(ctx context.Context, opts ...grpc.CallOption) (Remote_ReceiveClient, error) {
	stream, err := c.cc.NewStream(ctx, &Remote_ServiceDesc.Streams[0], "/cluster.Remote/Receive", opts...)
	if err != nil {
		return nil, err
	}
...
func (m *MemberJoin) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *MemberJoin) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *MemberJoin) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *MemberJoin) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
